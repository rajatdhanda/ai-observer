...
class VersionValidator {
    ...
    extractVersion(filename, content) {
    ...
    extractSchemaName(filename, content) {
    ...
    extractDeprecationDate(content) {
        const match = content.match(/DEPRECATION_DATE\s*=\s*['"`]([^'"`]+)['"`]/);
        return match ? match[1] : undefined;
    }
    checkVersioning(schemas) {
